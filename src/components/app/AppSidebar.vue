...
// Inject ile toggle fonksiyonunu al (isteğe bağlı, eğer sidebar içinden toggle gerekiyorsa)
...
.sidebar {
  ...
  top: 0;
  left: 0;
  background-color: var(--bg-sidebar, #2c3e50);
